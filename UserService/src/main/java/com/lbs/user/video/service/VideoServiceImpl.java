...
public class VideoServiceImpl implements VideoService {
    ...
    @Override
    public Video saveVideo(VideoUploadDto videoUploadDto, String storageURL, String thumbnailImageURL) {
        // 도메인 객체 만들어서 넘겨주기
        Video video = Video.createVideo(videoUploadDto, storageURL,thumbnailImageURL);
