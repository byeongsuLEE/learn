...
@RestController
@RequestMapping(name ="user_friend")
...
public class FriendController {
    ...
    public ResponseEntity<ApiResponse<List<FriendResponseDto>>> getFriends(@PathVariable Long my_user_id) {

        List<FriendResponseDto> friendResponseDtoList  = null;
